...
// --------------------------------------------------------------------------
//
// Small example of how to use [Clara](https://github.com/catchorg/Clara)
//
...
// this block of variables are changes by Clara it the corresponding options are passed
// to the program.
//
int width = 0;
std::string name;
...
// This is a special values which is set indirectly by an lamba function!
//
int index = 0;
