...
#if GTKMM_MAJOR_VERSION==3 && GTKMM_MINOR_VERSION<24
// in Debian 9, the gtkmm version does not know `make_managed` which is used
// by the example of the gtkmm book! So let's add it.
namespace Gtk {
